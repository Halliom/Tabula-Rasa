...
void SSAOBlurShader::Initialize()
{
    IShader::Initialize();
...
void SSAOBlurShader::LoadShader(GLint Program)
{
    ...
    const char* FragmentShaderSource = PlatformFileSystem::LoadFileIntoBuffer(DT_SHADERS, "FragmentShaderSSAOBlur.glsl");
