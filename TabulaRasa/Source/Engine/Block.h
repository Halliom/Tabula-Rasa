...
struct BlockInfo
{
	...
	BlockInfo(IDType BlockID, BlockType RenderType, unsigned int Textures[6]) :
		BlockID(BlockID), RenderType(RenderType)
	{
		memcpy(RenderData.Textures, Textures, sizeof(unsigned int) * 6);
	}

	BlockInfo(IDType BlockID, BlockType RenderType, unsigned int TextureEast, unsigned int TextureWest, unsigned int TextureTop, unsigned int TextureBottom, unsigned int TextureNorth, unsigned int TextureSouth) :
		BlockID(BlockID), RenderType(RenderType)
	{
	...
	BlockInfo(IDType BlockID, BlockType RenderType, unsigned int Width, unsigned int Height, unsigned int Depth) :
		BlockID(BlockID), RenderType(RenderType)
	{
